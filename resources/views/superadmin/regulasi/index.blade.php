                  ...
                  <div class="card">
                    <div class="card-close">
                      <div class="dropdown">
                        ...
                        <div aria-labelledby="closeCard1" class="dropdown-menu dropdown-menu-right has-shadow"><a href="{{url('/superadmin')}}" class="dropdown-item remove"> <i class="fa fa-times"></i>Close</a><a href="{{url('/createregulasiadmin')}}" class="dropdown-item edit"> <i class="fa fa-plus"></i>Tambah</a></div>
                      </div>
                    </div>

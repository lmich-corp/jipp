          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <div class="navbar-header">
                <!-- Navbar Brand --><a href="{{url('/superadmin')}}" class="navbar-brand">
      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
                    <li><a href="/superadmin"> <i class="icon-home"></i>Beranda </a></li>
                    <li><a href="/agendaadmin"> <i class="icon-grid"></i>Agenda </a></li>
                    <li><a href="/user"> <i class="icon-user"></i>Akun</a></li>
                    <li><a href="/wartaadmin"> <i class="icon-padnote"></i>Warta </a></li>
                    <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Master Referensi</a>
                      <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
                        <li><a href="/regulasiadmin">Regulasi</a></li>
                        <li><a href="/materiadmin">Materi</a></li>
                        <li><a href="/ebookadmin">Ebook</a></li>
                      </ul>
                    </li>
                    <li><a href="#exampledropdownDropdown2" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Data Inovasi</a>
                      <ul id="exampledropdownDropdown2" class="collapse list-unstyled ">
                        <li><a href="/inovasi">Inovasi</a></li>
                        <li><a href="/ideinovasi">Ide Inovasi</a></li>
                      </ul>
                    </li>
                    <li> <a href="/kontakkami"> <i class="icon-mail"></i>Kotak Saran</a></li>
                    <li><a href="/gantipassword"> <i class="icon-user"></i>Ganti Password</a></li>
          </ul>

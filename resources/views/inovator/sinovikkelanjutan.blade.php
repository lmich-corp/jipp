    ...
    <div class="col-md-4">
      ...
      <div class="col-md-12">
        <ul class="list-group nav">
          ...
          <li><a href="sinovikkelanjutan.html" class="list-group-item active">Berkelanjutan dan replikasi</a></li>
        </ul>
      </div>
    </div>
    <div class="col-md-8">
      <h4><strong>Berkelanjutan dan replikasi</strong></h4>
      <div class="form-group">
        <textarea class="form-control" name="kelanjutan" id="textArea"></textarea>
      </div>
      <div class="form-group">
